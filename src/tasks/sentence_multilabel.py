...
from ..data.multi_label_dataset import MultiLabelDataset

logger = logging.getLogger(__name__)


@register_task("sentence_multilabel")
class SentenceMultiLabelTask(LegacyFairseqTask):
    """
